...
After graduation, I was selected into the highly competitive Tencent Elite Product Manager Program [(腾讯产品经理培训生)](https://mp.weixin.qq.com/s/Xg1GtNG6ej3SUq9j6DGoLA), with an <span style="color: orange;">acceptance rate of 0.4%</span>. Over nearly three years at Tencent, I advanced to <span style="color: orange;">P8 (mid-to-senior level)</span> and worked across both the Livestreaming and Appstore teams. I led initiatives including a digital goods marketplace with 700K+ paying users and a CRM system powered by behavioral analytics. These experiences enhanced my skills in platform architecture, monetization strategy, and cross-functional leadership.
